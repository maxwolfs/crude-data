...
const char *ssid = "fakeland"; // The name of the Wi-Fi network that will be created
const char *password = "";   // The password required to connect to it, leave blank for an open network

const char *OTAName = "ESP8266";           // A name and a password for the OTA service
const char *OTAPassword = "esp8266";

const char* mdnsName = "google"; // Domain name for the mDNS responder
...
void startWiFi() { // Start a Wi-Fi access point, and try to connect to some given access points. Then wait for either an AP or STA connection
  ...
  wifiMulti.addAP("Palazzo-G", "Dienstbotenwohnung1");   // add Wi-Fi networks you want to connect to
  wifiMulti.addAP("pxl", "12345678");
...
// byte byteStringToByte (uint8_t * payload, int s, int e) {
//   byte sum = 0;
//   for (int i=s; i<e;i++) {
//     sum += payload[e-(i-s)-1] == '1' ? pow(2,i-s) : 0;
//   }
//   return sum;
// }
